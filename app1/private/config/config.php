...
|
*/
$config['base_url'] = 'http://localhost/mult_db_codeigniter/app1/';

$config['assets_url'] = 'http://localhost/mult_db_codeigniter/public/';
...
|
*/
$config['encryption_key'] = 'app1_key_defautl';
